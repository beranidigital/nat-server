...
class AppSettings1 extends Model
{
    use HasFactory;
    ...
    {
        parent::boot();
        self::saved(function (AppSettings1 $model) {
            self::$memCache[$model->key] = $model;
        });
    }

    public static function get(string $key): \Illuminate\Database\Eloquent\Collection|array|AppSettings1|null
    {
    ...
    public static function getPoolProfileParameter(): array
    {
        ...
        foreach (AppSettings1::getDevices() as $id => $name) {
