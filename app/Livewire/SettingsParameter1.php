 ...
 * @property Form form
 */
class SettingsParameter1 extends Component implements HasForms
{
    ...
    {
        $this->data = [
            'parameter_profile' => self::kvToArray(AppSettings1::getParameterProfile()),
            'pool_profile_parameter' => self::kvToArray(AppSettings1::getPoolProfileParameter()),
        ];
    ...
    {
        $sensors = [];
        $formattedSensor = AppSettings1::getTranslation()->value;
    ...
    {
        $parameters = [];
        foreach (AppSettings1::getParameterProfile() as $parameter => $value) {
    ...
    {
        return view('livewire.settings-parameter1');
    }
}
